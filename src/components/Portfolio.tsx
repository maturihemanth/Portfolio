...
const gdThumb = (id: string) => `https://drive.google.com/thumbnail?id=${id}&sz=w800`;

const projects = [
  { id: 1, title: '3 Types of Buyers',    category: 'Posters',      desc: 'Educational infographic-style poster for real estate buyers, combining strong typography with clear visual hierarchy.',                           tools: ['Photoshop'],                    image: gdThumb('1POPzQetPmOe04gcgPsQ2N5u2P0BW5Srq'), span: 'wide'   },
  { id: 2, title: 'Brand Identity Artwork', category: 'Branding',    desc: 'Bold graphic design artwork blending colour theory, typography, and digital illustration techniques.',                                              tools: ['Photoshop', 'Illustrator'],      image: gdThumb('1t7Nlkd31Awl5CEBsLBGstDeuovl1ZETw'), span: 'tall'   },
  ...
  { id: 4, title: 'MAD Design Campaign',   category: 'Social Media', desc: 'Bold social media creative combining experimental typography with vivid colour and impactful messaging.',                                             tools: ['Photoshop'],                    image: gdThumb('1NwOyo7d0lav1ZPOgCzekkehtqOhn8fpc'), span: 'normal' },
  { id: 5, title: 'NR Property Listing',   category: 'Real Estate',  desc: 'Clean, professional property listing creative designed for maximum readability and visual appeal.',                                                    tools: ['Photoshop', 'Premiere Pro'],    image: gdThumb('1akJuSLuf7CPKylH2SBqS4EIj4f0OMnhv'), span: 'wide'   },
  { id: 6, title: 'Villa Showcase',        category: 'Real Estate',  desc: 'Premium villa marketing creative for Property Edge Pvt. Ltd. - blending luxury aesthetics with property highlights.',                                   tools: ['Photoshop', 'Premiere Pro'],    image: gdThumb('1So1zVbM506Wz8Bzl4HuXbjw5jXxGeL1c'), span: 'normal' },
  { id: 7, title: 'Property Creative',     category: 'Posters',      desc: 'Visually compelling property campaign creative with bold layout and high-contrast brand elements.',                                                     tools: ['Photoshop'],                    image: gdThumb('1OBoS9APDdwn8YtikOSs1scT5VvZV8Cgu'), span: 'tall'   },
  { id: 8, title: 'Cinematic Portrait',    category: 'Photography',  desc: 'Dramatic dark-tone portrait with gold highlights and fine detail retouching for premium brand use.',                                                   tools: ['Photoshop', 'Lightroom'],       image: getAssetPath('/IMG_0797.JPG'),                   span: 'normal' },
  { id: 9, title: 'Professional Headshot', category: 'Photography',  desc: 'Clean professional studio-style portrait ideal for branding and corporate identity.',                                                                   tools: ['Lightroom', 'Photoshop'],       image: getAssetPath('/IMG_0246.JPG'),                   span: 'normal' },
];
