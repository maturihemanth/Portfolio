      ...
      >
        ...
        <nav style={{ display: 'flex', gap: '0.2rem', alignItems: 'center' }} className="nav-desktop">
          {links.map(l => (
            <button key={l.href} onClick={() => go(l.href)}
              style={{
                ...
                color: active === l.href ? '#818cf8' : 'rgba(241,245,249,0.6)',
              ...
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = active === l.href ? '#818cf8' : 'rgba(241,245,249,0.6)'; (e.currentTarget as HTMLElement).style.background = 'none'; }}
            >{l.label}</button>
          ))}
          <button onClick={() => go('#contact')}
            ...
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = 'none'; (e.currentTarget as HTMLElement).style.boxShadow = '0 4px 20px rgba(99,102,241,0.35)'; }}
          >Hire Me</button>
        </nav>
